...
function MailCheck() {
  ...
  const handleEmailCheck = async () => {
    const response = await fetch('https://project1-backend-9whj.onrender.com/users/checkmail', {
      method: 'POST',
  ...
  const handlePasswordReset = async () => {
    const response = await fetch(`https://project1-backend-9whj.onrender.com/users/checkstring?token=${string}`, {
      method: 'POST',
